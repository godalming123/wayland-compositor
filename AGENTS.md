...
A wayland compositor built in smithay 0.7.0 (crates.io), forked from the smallvil example, with a custom workspace model.
...
- The `tty-udev` backend implementation is based on the implementation in anvil
